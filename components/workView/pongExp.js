...
const PongExp = () => {
  return (
    <>
      ...
      <p>
        For as long as I can remember, I've always been playing mahjong with my
        family. As kids, my sister and I learned by routinely playing against
        our aunties and uncles where we only bet quarters on each hand. Some
        Chinese New Years were also spent at our grandparents' houses playing
        mahjong. I've even played with my close friends on dorm room dressers in
        college!
      </p>
      <p>
        ...
        summer vacation, we'd take out the mahjong table, play a round, and then
        leave it out in its designated corner, knowing that someone would ask if
        everyone was down for another round of mahjong the next night. With some
        snacks, drinks, and good conversation, family mahjong time is something
        I constantly look forward to.
      </p>
      <p>
      ...
      <p>
        ...
        skill. To this day, I still don't agree with her. If all players played
        completely optimally meaning they always knew the best tile to throw out
        as well as whether or not they should take a thrown out tile, then it
        would be up to luck. However, while this calculation seems feasible for
        a computer, it certainly isn't for us humans as we make mistakes lots of
        times (and if my sister or I take more than 20 seconds to think, our
        parents like to make fun of us).
      </p>
      <p>
        At first, I wanted to create a tool that would watch the state of a
        mahjong game from one player's perspective and always tell you what the
        next optimal move was, similar to a chess engine. This would've been
        really cool as I could compare my move to the computer's move to see how
        I was doing, and we would then be able to see if my win rate skyrocketed
        or still hovered around 25%. However, there seemed to be a lot of
        obstacles to accomplish that without even considering the algorithm, the
        largest being how to track moves in a fast enough way that wouldn't
        disrupt flow of the game.
      </p>
      <p>
      ...
      <p>
        ...
        Sheets API and having to switch over to use MySQL instead, this wasn't
        too hard and proved extremely valuable! I kept the dashboard next to me
        as we played mahjong to track each hand and my parents always eagerly
        awaited seeing all of our earnings lines moving simultaneously.
      </p>
      <p>
        That didn't answer the question of whether or not we should all hover
        around a 25% win rate, though. In mahjong, different hands have
      ...
      <p>
        ...
        they didn't care if they were, say, down $20 all-time, they just wanted
        to feel good that they were up $5 today. Adding that just required a
        little bit of math on the backend, and the project was complete!
      </p>
      <p>
        So after building this, I've come to the conclusion that I'm pretty bad
